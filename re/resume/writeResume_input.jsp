...
String SQL1 = "insert into resume ";
String SQL2 = "values('rs'||trim(to_char(resume_SEQ.nextval,'000000')), ?,?,?, ?,?, ?,?,?,?,?,?,?, 1)";
// x rsNum
// 1 pNum
// 2 rsTitle
// 3 profileImage
...
try {
	...
	//pstmt.setString(1, ""); 
	pstmt.setString(1, "pm000001"); 
	pstmt.setString(2, rsTitle); 
